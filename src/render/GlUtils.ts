...
export class GlUtils {
   ...
   */
  static bindTex(gl: WebGL2RenderingContext, program: WebGLProgram, tex: WebGLTexture, key: string, unit: number) {
   ...
   */
  static packFloatArrayToTexture(gl: WebGL2RenderingContext, data: Float32Array, widthHint?: number) {
      if (data.length % 4 !== 0) {
