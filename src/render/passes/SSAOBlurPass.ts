...
export class SSAOBlurPass extends RenderPass {
    constructor(gl: WebGL2RenderingContext, resourceCache: ResourceCache, canvas: HTMLCanvasElement, renderGraph?: RenderGraph) {
        ...
        this.program = RenderUtils.CreateProgram(gl, SSAOBlurVertexShaderSource, SSAOBlurFragmentShaderSource)!;
    ...
    protected initRenderTarget(width?: number, height?: number): RenderTarget {
        ...
        const ssaoBlurTexture = TextureUtils.createTexture(this.gl, w, h, this.gl.R8, this.gl.RED, this.gl.UNSIGNED_BYTE);
    ...
    public render(vao_info: VaoInfo | VaoInfo[]): void {
        ...
        TextureUtils.bindTex(this.gl, this.program!, depthTexture, "depthTexture", 1);
