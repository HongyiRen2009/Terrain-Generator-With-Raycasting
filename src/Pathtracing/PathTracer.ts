...
export class PathTracer{
    ...
    public constructor(canvas: HTMLCanvasElement, context: WebGL2RenderingContext, world: WorldMap, camera: Camera, debug: DebugMenu){
        this.canvas = canvas;
        this.gl = context;
        this.world = world;
        this.camera = camera;
        ...
        //Pack triangles
        const {vertices, terrains} = BVHUtils.packTriangles(mainMesh.mesh,mainMesh.type);
