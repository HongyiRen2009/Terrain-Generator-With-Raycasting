...
export class SettingsSection {
  ...
  constructor(parentContainer: HTMLElement, title: string) {
...
export class SettingsManager {
  ...
  /**
   * Create a new settings section with a heading
   */
  createSection(id: string, title: string): SettingsSection {
    const section = new SettingsSection(this.container, title);
