...
function parseBinarySTLToArrays(buffer) {
    const view = new DataView(buffer);
    const numTriangles = view.getUint32(80, true);
...
function parseASCIISTLToArrays(text) {
    const positions = [];
    const normalsList = [];
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("190ae28c704c96a72e1e." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 			"src_modelLoader_StlWorker_ts": 1
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/modelLoader/StlWorker.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=src_modelLoader_StlWorker_ts.index.js.map